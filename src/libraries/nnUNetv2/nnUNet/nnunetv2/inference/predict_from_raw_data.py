...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        # For PRIMUS we need this
        if hasattr(trainer_class, '_setup_build_network_architecture') and callable(trainer_class._setup_build_network_architecture):
            trainer_class._setup_build_network_architecture(configuration_manager)
        ...
        with multiprocessing.get_context("spawn").Pool(num_processes_segmentation_export) as export_pool:
            ...
            for preprocessed in data_iterator:
                ...
                if ofile is not None:
                    ...
                    #                               self.dataset_json, ofile, save_probabilities, save_logits)
                    ...
                    #              properties,
                    #              save_probabilities, save_logits)
