...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    if not return_logits:
        ...
        # revert cropping
        predicted_logits = label_manager.revert_cropping_on_probabilities(predicted_logits,
                                                                                 properties_dict[
        ...
        elif not isinstance(predicted_logits, np.ndarray):
            predicted_logits = np.asarray(predicted_logits)
        # revert transpose
        predicted_logits = predicted_logits.transpose([0] + [i + 1 for i in
...
def export_prediction_from_logits(predicted_array_or_file: Union[np.ndarray, torch.Tensor], properties_dict: dict,
    ...
    ret = convert_predicted_logits_to_segmentation_with_correct_shape(
        ...
        return_probabilities=save_probabilities, return_logits=save_logits
    )
