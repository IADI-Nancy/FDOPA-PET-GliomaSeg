...
from nnunetv2.network_architecture.auxiliary_regression import PlainConvUNetAuxiliaryRegressor, ResidualEncoderUNetAuxiliaryRegressor
...
class ExperimentPlannerAuxiliaryRegression(ExperimentPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'AuxiliaryRegressionPreprocessor', plans_name: str = 'nnUNetPlansAuxReg',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, 
                         overwrite_target_spacing, suppress_transpose)
        self.UNet_class = PlainConvUNetAuxiliaryRegressor
    ...
    def get_plans_for_configuration(self,
        ...
        architecture_kwargs = {
            ...
            'arch_kwargs': {
                ...
                'num_outputs_aux_reg': self.dataset_json['auxiliary_regressor_num_outputs'],
            },
...
class ResEncUNetPlannerAuxiliaryRegression(ResEncUNetPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'AuxiliaryRegressionPreprocessor', plans_name: str = 'nnUNetResEncUNetPlansAuxReg',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, 
                         overwrite_target_spacing, suppress_transpose)
        self.UNet_class = ResidualEncoderUNetAuxiliaryRegressor
    ...
    def generate_data_identifier(self, configuration_name: str) -> str:
        ...
        if configuration_name == '2d' or configuration_name == '3d_fullres':
            ...
            return 'nnUNetPlansAuxReg' + '_' + configuration_name
        else:
...
class nnUNetPlannerResEncMAuxiliaryRegression(ResEncUNetPlannerAuxiliaryRegression):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'AuxiliaryRegressionPreprocessor', plans_name: str = 'nnUNetResEncUNetMPlansAuxReg',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
...
class nnUNetPlannerResEncLAuxiliaryRegression(ResEncUNetPlannerAuxiliaryRegression):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 24,
                 preprocessor_name: str = 'AuxiliaryRegressionPreprocessor', plans_name: str = 'nnUNetResEncUNetLPlansAuxReg',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
...
class nnUNetPlannerResEncXLAuxiliaryRegression(ResEncUNetPlannerAuxiliaryRegression):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 40,
                 preprocessor_name: str = 'AuxiliaryRegressionPreprocessor', plans_name: str = 'nnUNetResEncUNetXLPlansAuxReg',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
