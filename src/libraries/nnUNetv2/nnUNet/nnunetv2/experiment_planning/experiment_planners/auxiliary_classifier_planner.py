...
from nnunetv2.network_architecture.auxiliary_classification import PlainConvUNetAuxiliaryClassifier, ResidualEncoderUNetAuxiliaryClassifier
from nnunetv2.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from nnunetv2.experiment_planning.experiment_planners.residual_unets.residual_encoder_unet_planners import ResEncUNetPlanner, nnUNetPlannerResEncM, nnUNetPlannerResEncL, nnUNetPlannerResEncXL


class ExperimentPlannerAuxiliaryClassification(ExperimentPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'AuxiliaryClassificationPreprocessor', plans_name: str = 'nnUNetPlansAuxClass',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, 
                         overwrite_target_spacing, suppress_transpose)
        self.UNet_class = PlainConvUNetAuxiliaryClassifier
    ...
    def get_plans_for_configuration(self,
        ...
        architecture_kwargs = {
            ...
            'arch_kwargs': {
                ...
                'num_classes_aux_classif': len(list(self.dataset_json['auxiliary_classifier_labels'].values())),
            },
...
class ResEncUNetPlannerAuxiliaryClassification(ResEncUNetPlanner):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'AuxiliaryClassificationPreprocessor', plans_name: str = 'nnUNetResEncUNetPlansAuxClass',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name, 
                         overwrite_target_spacing, suppress_transpose)
        self.UNet_class = ResidualEncoderUNetAuxiliaryClassifier
    ...
    def generate_data_identifier(self, configuration_name: str) -> str:
        ...
        if configuration_name == '2d' or configuration_name == '3d_fullres':
            ...
            return 'nnUNetPlansAuxClass' + '_' + configuration_name
        else:
...
class nnUNetPlannerResEncMAuxiliaryClassification(ResEncUNetPlannerAuxiliaryClassification):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'AuxiliaryClassificationPreprocessor', plans_name: str = 'nnUNetResEncUNetMPlansAuxClass',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
...
class nnUNetPlannerResEncLAuxiliaryClassification(ResEncUNetPlannerAuxiliaryClassification):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 24,
                 preprocessor_name: str = 'AuxiliaryClassificationPreprocessor', plans_name: str = 'nnUNetResEncUNetLPlansAuxClass',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
...
class nnUNetPlannerResEncXLAuxiliaryClassification(ResEncUNetPlannerAuxiliaryClassification):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 40,
                 preprocessor_name: str = 'AuxiliaryClassificationPreprocessor', plans_name: str = 'nnUNetResEncUNetXLPlansAuxClass',
                 overwrite_target_spacing: Union[List[float], Tuple[float, ...]] = None,
                 suppress_transpose: bool = False):
        super().__init__(dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
                         overwrite_target_spacing, suppress_transpose)
